              ...
              >
                ...
                >
                  <Grid item xs={4}>
                    ...
                    <Typography size="md">
                      {" "}
                      <CountUp end={activeDriver} duration={1} />
                    </Typography>
                  </Grid>
                  <Grid item xs={4}>
                    <Typography color="text" colorBrightness="secondary" noWrap>
                    ...
                    <Typography size="md">
                      {" "}
                      <CountUp end={freeCnt} duration={1} />
                    </Typography>
                  </Grid>
                  <Grid item xs={4}>
                    <Typography color="text" colorBrightness="secondary" noWrap>
                    ...
                    <Typography size="md">
                      {" "}
                      <CountUp end={occupiedCnt} duration={1} />
                    </Typography>
                  </Grid>
                </Grid>
              </Widget>
              ...
              >
                ...
                >
                  <Grid item xs={4}>
                    ...
                    <Typography size="md">
                      {" "}
                      <CountUp end={assignedCarCnt} duration={1} />
                    </Typography>
                  </Grid>
                  <Grid item xs={4}>
                    <Typography color="text" colorBrightness="secondary" noWrap>
                    ...
                    <Typography size="md">
                      {" "}
                      <CountUp end={unAssignedCarCnt} duration={1} />
                    </Typography>
                  </Grid>
                  <Grid item xs={4}></Grid>
                </Grid>
