...
const ExpenseList = () => {
  ...
  const [expenseType, setExpenseType] = useState("pending");
  ...
  const exportToCsv = () => {
    ...
    let headers = ["Driver", "Date", "Type", "Department", "Amount", "Remark"];
                ...
                <div className={classes.mainChartHeaderLabel}>
                  ...
                  >
                    ...
                    >
                      ...
                      <MenuItem value="pending">Pending Expense</MenuItem>
                      <MenuItem value="accepted">Accepted Expense</MenuItem>
                      <MenuItem value="rejected">Rejected Expense</MenuItem>
                    </Select>
                  </FormControl>
                </div>
              </div>
